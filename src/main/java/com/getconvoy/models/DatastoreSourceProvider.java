...
/**
 * Gets or Sets datastore.SourceProvider
 */
public enum DatastoreSourceProvider {
  ...
  DatastoreSourceProvider(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreSourceProvider fromValue(String value) {
    for (DatastoreSourceProvider b : DatastoreSourceProvider.values()) {
