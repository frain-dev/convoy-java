...
/**
 * Gets or Sets datastore.DeviceStatus
 */
public enum DatastoreDeviceStatus {
  ...
  DatastoreDeviceStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreDeviceStatus fromValue(String value) {
    for (DatastoreDeviceStatus b : DatastoreDeviceStatus.values()) {
