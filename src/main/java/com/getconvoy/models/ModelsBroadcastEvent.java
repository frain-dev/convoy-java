 ...
 */
@JsonPropertyOrder({
  ModelsBroadcastEvent.JSON_PROPERTY_ACKNOWLEDGED_AT,
  ModelsBroadcastEvent.JSON_PROPERTY_CUSTOM_HEADERS,
  ModelsBroadcastEvent.JSON_PROPERTY_DATA,
  ModelsBroadcastEvent.JSON_PROPERTY_EVENT_TYPE,
  ModelsBroadcastEvent.JSON_PROPERTY_IDEMPOTENCY_KEY
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.23.0")
public class ModelsBroadcastEvent {
  ...
  public ModelsBroadcastEvent() { 
  }

  public ModelsBroadcastEvent acknowledgedAt(@jakarta.annotation.Nullable String acknowledgedAt) {
  ...
  public ModelsBroadcastEvent customHeaders(@jakarta.annotation.Nullable Map<String, String> customHeaders) {
  ...
  public ModelsBroadcastEvent data(@jakarta.annotation.Nullable Map<String, Object> data) {
  ...
  public ModelsBroadcastEvent eventType(@jakarta.annotation.Nullable String eventType) {
  ...
  public ModelsBroadcastEvent idempotencyKey(@jakarta.annotation.Nullable String idempotencyKey) {
  ...
  /**
   * Return true if this models.BroadcastEvent object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ModelsBroadcastEvent modelsBroadcastEvent = (ModelsBroadcastEvent) o;
    return Objects.equals(this.acknowledgedAt, modelsBroadcastEvent.acknowledgedAt) &&
        equalsNullable(this.customHeaders, modelsBroadcastEvent.customHeaders) &&
        equalsNullable(this.data, modelsBroadcastEvent.data) &&
        Objects.equals(this.eventType, modelsBroadcastEvent.eventType) &&
        Objects.equals(this.idempotencyKey, modelsBroadcastEvent.idempotencyKey);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(acknowledgedAt, hashCodeNullable(customHeaders), hashCodeNullable(data), eventType, idempotencyKey);
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsBroadcastEvent {\n");
