 ...
 */
@JsonPropertyOrder({
  ModelsUpdateEventType.JSON_PROPERTY_CATEGORY,
  ModelsUpdateEventType.JSON_PROPERTY_DESCRIPTION,
  ModelsUpdateEventType.JSON_PROPERTY_JSON_SCHEMA
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.23.0")
public class ModelsUpdateEventType {
  ...
  public ModelsUpdateEventType() { 
  }

  public ModelsUpdateEventType category(@jakarta.annotation.Nullable String category) {
  ...
  public ModelsUpdateEventType description(@jakarta.annotation.Nullable String description) {
  ...
  public ModelsUpdateEventType jsonSchema(@jakarta.annotation.Nullable Map<String, Object> jsonSchema) {
  ...
  /**
   * Return true if this models.UpdateEventType object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ModelsUpdateEventType modelsUpdateEventType = (ModelsUpdateEventType) o;
    return Objects.equals(this.category, modelsUpdateEventType.category) &&
        Objects.equals(this.description, modelsUpdateEventType.description) &&
        equalsNullable(this.jsonSchema, modelsUpdateEventType.jsonSchema);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(category, description, hashCodeNullable(jsonSchema));
  }
  ...
  public String toString() {
    ...
    sb.append("class ModelsUpdateEventType {\n");
