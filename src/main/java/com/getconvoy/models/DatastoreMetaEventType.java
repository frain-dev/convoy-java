...
/**
 * Gets or Sets datastore.MetaEventType
 */
public enum DatastoreMetaEventType {
  ...
  DatastoreMetaEventType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreMetaEventType fromValue(String value) {
    for (DatastoreMetaEventType b : DatastoreMetaEventType.values()) {
