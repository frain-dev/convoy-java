...
public class ModelsIDs {
  ...
  public ModelsIDs ids(@jakarta.annotation.Nullable List<String> ids) {
    this.ids = ids;
    return this;
  }

  public ModelsIDs addIdsItem(String idsItem) {
    if (this.ids == null) {
  ...
  /**
   * Return true if this models.IDs object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ModelsIDs modelsIDs = (ModelsIDs) o;
    return Objects.equals(this.ids, modelsIDs.ids);
  }
