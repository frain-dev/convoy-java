...
/**
 * Gets or Sets datastore.PortalAuthType
 */
public enum DatastorePortalAuthType {
  ...
  DatastorePortalAuthType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastorePortalAuthType fromValue(String value) {
    for (DatastorePortalAuthType b : DatastorePortalAuthType.values()) {
