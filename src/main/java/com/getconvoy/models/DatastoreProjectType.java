...
/**
 * Gets or Sets datastore.ProjectType
 */
public enum DatastoreProjectType {
  ...
  DatastoreProjectType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreProjectType fromValue(String value) {
    for (DatastoreProjectType b : DatastoreProjectType.values()) {
