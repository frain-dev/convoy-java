...
/**
 * Gets or Sets datastore.EventStatus
 */
public enum DatastoreEventStatus {
  ...
  DatastoreEventStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreEventStatus fromValue(String value) {
    for (DatastoreEventStatus b : DatastoreEventStatus.values()) {
