...
/**
 * Gets or Sets datastore.EndpointStatus
 */
public enum DatastoreEndpointStatus {
  
  ActiveEndpointStatus("active"),
  ...
  DatastoreEndpointStatus(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreEndpointStatus fromValue(String value) {
    for (DatastoreEndpointStatus b : DatastoreEndpointStatus.values()) {
