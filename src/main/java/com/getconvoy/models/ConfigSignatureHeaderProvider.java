...
/**
 * Gets or Sets config.SignatureHeaderProvider
 */
public enum ConfigSignatureHeaderProvider {
  ...
  ConfigSignatureHeaderProvider(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ConfigSignatureHeaderProvider fromValue(String value) {
    for (ConfigSignatureHeaderProvider b : ConfigSignatureHeaderProvider.values()) {
