 ...
 */
@JsonPropertyOrder({
  DatastoreRateLimitConfiguration.JSON_PROPERTY_COUNT,
  DatastoreRateLimitConfiguration.JSON_PROPERTY_DURATION
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.23.0")
public class DatastoreRateLimitConfiguration {
  ...
  public DatastoreRateLimitConfiguration() { 
  }

  public DatastoreRateLimitConfiguration count(@jakarta.annotation.Nullable Integer count) {
    this.count = count;
    return this;
  }
  ...
  public DatastoreRateLimitConfiguration duration(@jakarta.annotation.Nullable Integer duration) {
  ...
  /**
   * Return true if this datastore.RateLimitConfiguration object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DatastoreRateLimitConfiguration datastoreRateLimitConfiguration = (DatastoreRateLimitConfiguration) o;
    return Objects.equals(this.count, datastoreRateLimitConfiguration.count) &&
        Objects.equals(this.duration, datastoreRateLimitConfiguration.duration);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatastoreRateLimitConfiguration {\n");
