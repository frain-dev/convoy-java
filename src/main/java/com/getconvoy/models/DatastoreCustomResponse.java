 ...
 */
@JsonPropertyOrder({
  DatastoreCustomResponse.JSON_PROPERTY_BODY,
  DatastoreCustomResponse.JSON_PROPERTY_CONTENT_TYPE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.23.0")
public class DatastoreCustomResponse {
  ...
  public DatastoreCustomResponse() { 
  }

  public DatastoreCustomResponse body(@jakarta.annotation.Nullable String body) {
    this.body = body;
    return this;
  }
  ...
  public DatastoreCustomResponse contentType(@jakarta.annotation.Nullable String contentType) {
  ...
  /**
   * Return true if this datastore.CustomResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    DatastoreCustomResponse datastoreCustomResponse = (DatastoreCustomResponse) o;
    return Objects.equals(this.body, datastoreCustomResponse.body) &&
        Objects.equals(this.contentType, datastoreCustomResponse.contentType);
  }
  ...
  public String toString() {
    ...
    sb.append("class DatastoreCustomResponse {\n");
