...
/**
 * Gets or Sets datastore.SourceType
 */
public enum DatastoreSourceType {
  
  HTTPSource("http"),
  
  RestApiSource("rest_api"),
  ...
  DatastoreSourceType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreSourceType fromValue(String value) {
    for (DatastoreSourceType b : DatastoreSourceType.values()) {
