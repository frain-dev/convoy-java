...
/**
 * Gets or Sets config.RequestIDHeaderProvider
 */
public enum ConfigRequestIDHeaderProvider {
  ...
  ConfigRequestIDHeaderProvider(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static ConfigRequestIDHeaderProvider fromValue(String value) {
    for (ConfigRequestIDHeaderProvider b : ConfigRequestIDHeaderProvider.values()) {
