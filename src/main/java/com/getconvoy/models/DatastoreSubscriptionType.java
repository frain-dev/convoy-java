...
/**
 * Gets or Sets datastore.SubscriptionType
 */
public enum DatastoreSubscriptionType {
  ...
  DatastoreSubscriptionType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreSubscriptionType fromValue(String value) {
    for (DatastoreSubscriptionType b : DatastoreSubscriptionType.values()) {
