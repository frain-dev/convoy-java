...
/**
 * Gets or Sets datastore.DeliveryMode
 */
public enum DatastoreDeliveryMode {
  ...
  DatastoreDeliveryMode(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreDeliveryMode fromValue(String value) {
    for (DatastoreDeliveryMode b : DatastoreDeliveryMode.values()) {
