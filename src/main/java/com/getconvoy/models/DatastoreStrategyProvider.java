...
/**
 * Gets or Sets datastore.StrategyProvider
 */
public enum DatastoreStrategyProvider {
  ...
  DatastoreStrategyProvider(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreStrategyProvider fromValue(String value) {
    for (DatastoreStrategyProvider b : DatastoreStrategyProvider.values()) {
