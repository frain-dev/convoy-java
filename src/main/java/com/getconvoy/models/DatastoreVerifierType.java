...
/**
 * Gets or Sets datastore.VerifierType
 */
public enum DatastoreVerifierType {
  ...
  DatastoreVerifierType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static DatastoreVerifierType fromValue(String value) {
    for (DatastoreVerifierType b : DatastoreVerifierType.values()) {
