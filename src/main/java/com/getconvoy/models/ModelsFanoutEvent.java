...
public class ModelsFanoutEvent {
  ...
  public boolean equals(Object o) {
    ...
    return equalsNullable(this.customHeaders, modelsFanoutEvent.customHeaders) &&
        equalsNullable(this.data, modelsFanoutEvent.data) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(hashCodeNullable(customHeaders), hashCodeNullable(data), eventType, idempotencyKey, ownerId);
  }
