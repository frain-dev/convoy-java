...
public class OnboardApi {
  ...
  public OnboardApi(ApiClient apiClient) {
    ...
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("bulkOnboard", localVarResponse);
        }
        localVarResponseBody = ApiClient.getResponseBody(localVarResponse);
        if (localVarResponseBody == null) {
          return new ApiResponse<BulkOnboard200Response>(
        ...
        BulkOnboard200Response responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<BulkOnboard200Response>() {});
  ...
  private HttpRequest.Builder bulkOnboardRequestBuilder(@jakarta.annotation.Nonnull String projectID, @jakarta.annotation.Nullable Boolean dryRun, @jakarta.annotation.Nullable ModelsBulkOnboardRequest modelsBulkOnboardRequest, Map<String, String> headers) throws ApiException {
    ...
    String localVarPath = "/v1/projects/{projectID}/onboard"
